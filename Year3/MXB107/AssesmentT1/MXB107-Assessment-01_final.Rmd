...
##  data(episodes)
episodes
plot1 <- ggplot(episodes %>% filter(Series == "TNG"),aes(x = filter(IMDB.Ranking=="Y"))+
  geom_histogram(bins = 13)+xlab(""))
...
:::{.box}
**Type your answer here:**
For this question we can use probabiity rules, where Pr(A) = number of ways that A can occur, over total number of outcomes. Pr(A) = 366/704 = 0.5198864.
